...
Zadaniem postawionym przed robotem jest, poza znalezieniem celu, także odpowiednie zachowanie się po jego wykryciu. Jako cel przyjęto ustawienie się przodem do celu, w odpowiedniej od niego odległości.
