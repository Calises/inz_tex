...
\end{lstlisting}
%Inicjalizacja licznika Timer1 jako układu odmierzącego czas pomiędzy kolejnymi zboczami sygnału podawanego na wejście ICP1.
...
\end{lstlisting}
%Inicjalizacja generatora PWM przy pomocy licznika Timer2.
\noindent
...
\end{lstlisting}
%Implementacja funkcji sterującej licznikiem Timer2.
...
\end{lstlisting}
%Uruchomienie interfejsu TWI oraz przypisanie adresu urządzenia.
...
\end{lstlisting}
%Fragment przerwania obsługującego komunikację TWI, który jest odpowiedzialny za wysłanie wskazanego bajtu.
...
case TWI_SRX_ADR_DATA_ACK: // 0x80
	...
	break;
\end{lstlisting}
%Fragment przerwania obsługującego komunikację TWI, który jest odpowiedzialny za odbiór informacji.
...
\end{lstlisting}
%Program realizujący funkcję regulatora P.
